...
{
	/// <summary>
	/// Used to edit a project config.
	/// </summary>
	public class EditProjectConfigModel
	{
		/// <summary>
		...
		/// <summary>
		/// Gets or sets the project config identifier.
		/// </summary>
		/// <value>
		/// The project config identifier.
		/// </value>
		...
		/// <summary>
		/// Gets or sets the original project config name.
		/// </summary>
		/// <value>
		/// The original project config name.
		/// </value>
